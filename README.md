...
| Week  | Activity |
| ------------- | ------------- |
| Week 1  | Introduction to Machine Learning, Tools, and Research <br><br> Tuesday: Introduction to Research <br> Wednesday: Linear and Logistic Regression <br> Thursday: k-Nearest Neighbors and Support Vector Machines <br> Friday: Neural Networks and Deep Learning (DNN, CNN, RNN)|
